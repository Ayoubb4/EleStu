// src/migrations/1749466674725-InitialSchema.ts
...
export class InitialSchema1749466674725 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // --- MODIFICADO: Añadido "serviceType" directamente en la creación de la tabla ---
        await queryRunner.query(`CREATE TABLE "Servicios" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "price" integer NOT NULL, "image" character varying, "serviceType" character varying NOT NULL DEFAULT 'Otro', "userid" integer, CONSTRAINT "PK_5dc10ec4063251070db0499e74f" PRIMARY KEY ("id"))`);
